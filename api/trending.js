module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const videos = (d.items || []).map(v => ({
      ...
      channelId: v.snippet.channelId, views: parseInt(v.statistics.viewCount || 0),
      likes: parseInt(v.statistics.likeCount || 0), comments: parseInt(v.statistics.commentCount || 0),
      duration: v.contentDetails.duration, thumbnail: v.snippet.thumbnails?.medium?.url || '',
